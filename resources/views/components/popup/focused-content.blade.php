                    ...
                    <div class="z-10 flex-grow mt-1 -mb-1 ml-1 -mr-1 p-1 max-w-10/12 bg-white rounded-md">
                        ...
                        <div class="flex flex-col p-2 border-b font-bold">
                            <div class="flex flex-row">
                                ...
                                <svg wire:click="{{ $closeMethodName ?? '' }}" class="cursor-pointer w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" xml:space="preserve">
                                <g>
